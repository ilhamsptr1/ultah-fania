...
const birthdayData = {
    ...
    memories: [
        ...
        { image: "https://i.pinimg.com/736x/ac/16/32/ac163249e82a56e2ea3b36fbcbea1dad.jpg", caption: "pas rayain ultah kamu di cocote" },
    ...
    messages: [
        ...
        { sender: "Bbebek Madura", avatar: "https://i.pinimg.com/736x/50/21/26/5021262f5386cb36f3791281f0dcb6cb.jpg", message: "Hii temanku selamat ulang tahunn" },
    ],
...
function fillProfileData() {
    ...
    detailsList[3].innerHTML = `<span>Kualitas Terbaik:</span> ${birthdayData.qualities}`;
}
